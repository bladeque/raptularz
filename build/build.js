...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/home/bladeque/_dev/raptularz/src/components/App.vue"
	  if (!module.hot.data) {
...
/***/ (function(module, exports) {
	...
	module.exports = "\n  <div class=\"page-header\">\n    <h1 class=\"text-center\">Raptularz <small>music scene</small></h1>\n  </div>\n  <div class=\"container\">\n    <router-view></router-view>\n  </div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/bladeque/_dev/raptularz/src/components/Home.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports) {
	...
	exports.default = {
	  ...
	  methods: {
	    getPlayListItems: function getPlayListItems(pageToken) {
	      var _this = this;

	      this.loadingVideos = true;

	      var url = 'https://www.googleapis.com/youtube/v3/playlistItems?' + 'part=contentDetails' + '&maxResults=5' + ('&playlistId=' + this.playlistId) + ('&key=' + this.apiKey);
	      ...
	      this.$http.get(url, function (data) {
	        _this.videos = _this.videos.concat(data.items);
	        _this.nextPage = data.nextPageToken;

	        _this.loadingVideos = false;

	        _this.updateLatestItem(_this.videos[0]);
	      }).error(function (err) {
	    ...
	    updateLatestItem: function updateLatestItem(item) {
	      if (!item) {
	        return;
	      }

	      var lastSavedVideoId = localStorage.getItem('latestVideoId');
	      var latestVideoId = item && item.contentDetails.videoId;
